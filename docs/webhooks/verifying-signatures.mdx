...
Your verification code should accept the delivery if **any** of the signatures is valid. This means you can continue using your current secret while we complete the rotation — no changes are needed on your end until the old secret is fully retired.
